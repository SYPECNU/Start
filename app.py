...
# 各种特征的输入控件
ankle_angle = st.sidebar.slider("Ankle plantar/dorsiflexion angle", min_value=-50.0, max_value=50.0, value=0.0)
ankle_inversion = st.sidebar.slider("Ankle in/eversion angle", min_value=-50.0, max_value=50.0, value=0.0)
...
ankle_power = st.sidebar.slider("Ankle power", min_value=-100.0, max_value=100.0, value=5.0)
grf = st.sidebar.slider("A/P GRF", min_value=-80.0, max_value=80.0, value=50.0)
...
hip_power = st.sidebar.slider("Hip power", min_value=-100.0, max_value=100.0, value=5.0)
