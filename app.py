...
# 各种特征的输入控件
ankle_angle = st.sidebar.slider("Ankle plantar/dorsiflexion angle", min_value=-50, max_value=50, value=0)
ankle_inversion = st.sidebar.slider("Ankle in/eversion angle", min_value=-50, max_value=50, value=0)
ankle_moment = st.sidebar.slider("Ankle plantar/dorsiflexion moment", min_value=-10, max_value=10.0, value=0.5)
ankle_inversion_moment = st.sidebar.slider("Ankle in/eversion moment", min_value=-10, max_value=10.0, value=0.5)
ankle_power = st.sidebar.slider("Ankle power", min_value=-100, max_value=100, value=5.0)
grf = st.sidebar.slider("A/P GRF", min_value=-80, max_value=80, value=50.0)
...
hip_power = st.sidebar.slider("Hip power", min_value=-100, max_value=100.0, value=5.0)
knee_ad_abduction_angle = st.sidebar.slider("Knee ad/abduction angle", min_value=-80.0, max_value=80.0, value=0.0)
...
soleus_emg = st.sidebar.slider("EMG activation for soleus", min_value=0.0, max_value=1, value=0.5)
